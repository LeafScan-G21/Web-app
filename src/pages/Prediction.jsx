      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Care Advice */}
            {data.disease_data?.care_advices && (
              <div className="bg-white rounded-2xl shadow-lg p-6">
                <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                  <Lightbulb className="mr-2 text-green-600" size={24} />
                  Treatment & Care Advice
                </h2>
                <div className="text-gray-700 leading-relaxed bg-green-50 p-4 rounded-xl border-l-4 border-green-500">
                  {formatText(data.disease_data.care_advices)}
                </div>
              </div>
            )}
          </div>
